                                        ...
                                        <div className="mil-description">
                                            <div className="mil-secrc-text">
                                                ...
                                                <ul className="mil-social-icons mil-center">
                                                    ...
                                                    <li key={`services1-item${key}-social-${key2}`}><a href={social.link} target="_blank" rel="noopener noreferrer" className="social-icon" title={social.title}> <i className={social.icon} /></a></li>
                                                    ))}
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div key={`services2-item-${key}`} className="mil-team-card mil-up mil-mb-30">
                                        ...
                                        <div className="mil-description">
                                            <div className="mil-secrc-text">
                                                ...
                                                <ul className="mil-social-icons mil-center">
                                                    {item.social.map((social, key2) => (
                                                    <li key={`services2-item${key}-social-${key2}`}><a href={social.link} target="_blank" rel="noopener noreferrer" className="social-icon" title={social.title}> <i className={social.icon} /></a></li>
                                                    ))}
                                                </ul>
                                            </div>
                                        </div>
